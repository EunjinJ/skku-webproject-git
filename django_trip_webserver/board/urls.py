...
urlpatterns = [
    ...
    path('trip/<int:trip_id>', views.trip_detail, name='trip_detail'),  # trip_detail 뷰에 대한 URL 경로 추가
    ...
    path('trip/<int:trip_id>/edit/', views.trip_edit, name="trip_edit"), # trip_edit 뷰에 대한 URL 경로 추가
    path('trip/<int:trip_id>/del/', views.trip_delete, name='trip_delete'), # trip_delete 뷰에 대한 URL 경로 추가
